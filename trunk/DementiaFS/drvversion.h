...
#define TEXT_PRODUCTNAME       Dementia file system mini filter driver // product's name
#define TEXT_FILEDESC          Dementia file system mini filter driver // component description
#define TEXT_COMPANY           Infigo IS d.o.o. // company
#define TEXT_MODULE            DementiaFS // module name
...
#define TEXT_INTERNALNAME      DementiaFS.sys // copyright information
